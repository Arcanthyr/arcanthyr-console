...
- **retrieval_baseline.sh — session 64 confirmed working:** stale BROKEN flag cleared · 4-step diagnostic confirms KEY extraction (44 chars, correct), no stale env KEY, manual replication returns chunks · current score 10/13/8 · full results at ~/retrieval_baseline_results_apr16.txt
